...
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { a4988[0] }]; #IO_0_14 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { a4988[1] }]; #IO_L6N_T0_D08_VREF_14 Sch=ck_io[1]
